...
class Pairing extends React.PureComponent {
  static propTypes = {
  ...
  render () {
    ...
    return (
      <div>
        <h2 style={{fontWeight:'bold', fontSize: 'xx-large'}}>{pairing.name}</h2>
        <Card style={{ margin: '10px auto' }}>
          <div className="uk-grid">
            <div className="uk-width-large-1-3 uk-width-medium-1-1">
        ...
        <Card style={{ margin: '10px auto' }}>
          <h2 style={{fontWeight:'bold', fontSize: 'x-large'}}>Sentimen Media</h2>
          <SimpleList>
            <thead>
              <tr>
                <th>Nama</th>
...
const mapStateProps = state => ({
  ...
  loading: state.pairings.loading_pairing
});
